...
//PREP
//P: arr of number, it can be neg, it can be zero, unsorted
//R: ve have to return reverse order 
//E: [1,2,3] => [1,2,3,2,1]
//P: first we wil sort the array, then we will reverse for loop and push it

function mirror(data) {
    let oneArr = data
    let newArr = [...oneArr].sort((a,b) => a-b)
    console.log(newArr)
    let arr = newArr;
